 ...
 * 
 * This is the heart of the application that provides:
 ...
 * 
 * Data Flow:
 * 1. User inputs text queries
 * 2. Backend queries grade database using SQL
 * 3. Backend generates AI response using OpenAI
 * 4. Frontend displays results with charts and statistics
 */
const ChatBot = () => {
   ...
   * 1. Frontend: Send user message to backend
   * 2. Backend: Parse message for professor/course names
   * 3. Backend: Query grade database using SQL (DatabaseService)
   * 4. Backend: Generate AI response using OpenAI (ChatGPTService)
   * 5. Frontend: Display response with interactive charts
   * 
   * The backend orchestrates services to provide comprehensive insights
   */
        ...
        <div className="card h-[600px] flex flex-col animate-scale-in">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
               ...
               <div className="flex items-center justify-between mb-6">
                 ...
                 <div className="flex items-center space-x-3">
                   ...
                   <button
                     ...
                     className="p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg transition-all duration-200"
                     title="Hide charts"
                   >
           ...
           {chartData && !showCharts && (
             <div className="border-t border-gray-200 dark:border-gray-700 p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20">
